                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-5" data-aos="fade-up">
                                ...
                                <form class="php-email-form mt-1">
                                    <div class="row">
                            ...
                            <div class="col-lg-12 mt-5" data-aos="fade-up">
                                ...
                                <form class="php-email-form mt-4">
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-md-4 d-flex justify-content-center form-group">
                                            <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" required />
                                        </div>
                                        <div class="col-md-4  d-flex justify-content-center form-group mt-3 mt-md-0">
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required />
                                        </div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                    ...
                                    <div class=" col-md-8 d-flex justify-content-center form-group mt-3">
                                        <textarea class="form-control" name="message" rows="5" placeholder="Message" required></textarea>
                                    </div>
                                    </div>
